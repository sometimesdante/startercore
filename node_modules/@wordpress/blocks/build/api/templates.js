...
function synchronizeBlocksWithTemplate() {
  ...
  return template.map((_ref2, index) => {
    ...
    let [blockName, blockAttributes] = (0, _convertLegacyBlock.convertLegacyBlockNameAndAttributes)(name, normalizedAttributes); // If a Block is undefined at this point, use the core/missing block as
